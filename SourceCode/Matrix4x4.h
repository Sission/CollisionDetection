...
public:
	...
	Vector3D operator *(const Vector4D& vector)
	{
		Vector3D out;
		out.m_x = m_mat[0][0] * vector.m_x + m_mat[1][0] * vector.m_y + m_mat[2][0] * vector.m_z + m_mat[3][0] * vector.m_w;
		out.m_y = m_mat[0][1] * vector.m_x + m_mat[1][1] * vector.m_y + m_mat[2][1] * vector.m_z + m_mat[3][1] * vector.m_w;
		out.m_z = m_mat[0][2] * vector.m_x + m_mat[1][2] * vector.m_y + m_mat[2][2] * vector.m_z + m_mat[3][2] * vector.m_w;
